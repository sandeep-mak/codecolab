    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                ...
                try {
                    const permRes = await axios.get(`http://localhost:8080/api/environments/${id}/permissions/me`, {
                ...
                // Fetch Environment
                const envRes = await axios.get(`http://localhost:8080/api/environments/${id}`, {
                    headers: { Authorization: `Bearer ${token}` }
                });
    ...
    const handleSave = async () => {
        ...
        try {
            if (activeFile) {
                ...
                await axios.put(`http://localhost:8080/api/files/${activeFile.id}`, {
                    content
                }, {
                    headers: { Authorization: `Bearer ${token}` }
                });
            ...
            if (docRef.current) {
                ...
                await axios.put(`http://localhost:8080/api/environments/${id}/whiteboard`, {
                    data
                }, {
                    headers: { Authorization: `Bearer ${token}` }
                });
